...
diabetes_model = pickle.load(open(r'E:\MediPredict-main\MediPredict-main\dataFiles\diabetes.csv','rb'))
heart_model = pickle.load(open(r"E:\MediPredict-main\MediPredict-main\dataFiles\heart_disease_data.csv",'rb'))
parkinsons_model = pickle.load(open(r"E:\MediPredict-main\MediPredict-main\dataFiles\parkinsons.csv",'rb'))
breast_model = pickle.load(open(r"E:\MediPredict-main\MediPredict-main\dataFiles\cancer_data.csv",'rb'))
